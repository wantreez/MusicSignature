...
package com.wantreez.iot.musicsignature.bt;
...
public class BluetoothList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int listId = getIntent().getIntExtra("layout_list", R.layout.acitivty_bluetooth);
        ...
        int layout_text = getIntent().getIntExtra("layout_text", R.layout.bluetooth_row);
